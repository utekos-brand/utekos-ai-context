...
For more details on these codes, see [API Design Guide - Error
...
2. Check for the [standard detail payload](https://developers.google.com/data-manager/api/devguides/concepts/understand-errors#standard-detail-payloads) for the
   error code. The standard detail payloads are a [set of messages for errors
...
- [`Help` and `LocalizedMessage`](https://developers.google.com/data-manager/api/devguides/concepts/understand-errors#help)
