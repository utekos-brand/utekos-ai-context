...
With [Vercel Sandbox](/docs/sandbox), you can safely run untrusted or user-generated code on Vercel in isolated, persistent Linux microVMs using the `@vercel/sandbox` SDK.
